...
const Home: React.FC = () => {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen w-100vw bg-gray-50 text-gray-900">
      
      {/* Hero Section */}
      <section className="flex flex-col md:flex-row items-center justify-between text-center md:text-left p-10 bg-gradient-to-r from-gray-800 to-slate-950 text-white w-full">
      ...
      <section className="p-8 md:p-10 mt-10 max-w-5xl mx-auto bg-white shadow-lg rounded-lg">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="bg-gray-200 rounded-lg p-5 shadow-md">
            ...
            <Link href="https://github.com/project-one" target="_blank" className="text-blue-500 hover:underline mt-4 inline-block">
              View on GitHub
            </Link>
          </div>
          <div className="bg-gray-200 rounded-lg p-5 shadow-md">
            ...
            <p className="text-lg">Description of the project and the technologies used.</p>
            <Link href="https://github.com/project-two" target="_blank" className="text-blue-500 hover:underline mt-4 inline-block">
              View on GitHub
            </Link>
          </div>
        </div>
      ...
      <section className="p-8 md:p-10 mt-10 max-w-5xl mx-auto bg-white shadow-lg rounded-lg">
        ...
        <div className="flex flex-wrap justify-center gap-4">
          <span className="bg-blue-500 text-white px-4 py-2 rounded-full">React.js</span>
          <span className="bg-blue-500 text-white px-4 py-2 rounded-full">Node.js</span>
          <span className="bg-blue-500 text-white px-4 py-2 rounded-full">TypeScript</span>
          <span className="bg-blue-500 text-white px-4 py-2 rounded-full">Next.js</span>
          <span className="bg-blue-500 text-white px-4 py-2 rounded-full">Tailwind CSS</span>
          <span className="bg-blue-500 text-white px-4 py-2 rounded-full">Express.js</span>
        </div>
      </section>
      ...
      <section className="p-8 md:p-10 mt-10 max-w-5xl mx-auto bg-white shadow-lg rounded-lg">
        ...
        <div className="flex justify-center space-x-4">
          <Link href="mailto:gagankishor101@gmail.com" className="bg-blue-500 text-white px-5 py-3 rounded-lg hover:bg-blue-700 transition duration-300 shadow-lg">
            Email Me
          </Link>
          <Link href="https://www.linkedin.com/in/gagankishor-19423b18b" target="_blank" className="bg-blue-500 text-white px-5 py-3 rounded-lg hover:bg-blue-700 transition duration-300 shadow-lg">
            LinkedIn
          </Link>
        </div>
      </section>
